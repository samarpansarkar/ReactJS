...
const UserProfile = () => {
    ...
    return (
        <div className="p-4 bg-white border border-indigo-100 rounded shadow-sm">
            <h4 className="font-bold text-indigo-900 mb-2">User Profile Component</h4>
            <div className="text-sm text-gray-600">
                <p>Start Date: 2024</p>
                {/* This data came all the way from Dashboard without props! */}
                <p className="font-bold text-indigo-600 mt-2">Active User: {user.name}</p>
...
const Sidebar = () => {
    return (
        <div className="p-4 bg-gray-50 border rounded h-full">
            <h3 className="font-bold text-gray-700 mb-4">Sidebar</h3>
        ...
        <div className="space-y-6">
            <div className="p-6 bg-white border border-gray-200 rounded-lg">
                <div className="flex justify-between items-center mb-6">
                    <h3 className="text-xl font-bold">Context API Example</h3>
                    <button
                ...
                <UserContext.Provider value={user}>
                    <div className="border-2 border-dashed border-gray-300 p-4 rounded-lg">
                        <p className="text-xs font-mono text-gray-400 mb-2">Dashboard (Provider)</p>
                        <Sidebar />
                    </div>
